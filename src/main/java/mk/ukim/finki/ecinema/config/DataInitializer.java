...
public class DataInitializer {
    ...
    public void initData() {
        ...
        //subscriptions
        this.subscriptionService.save("Monthly Plan", "mesecna pretplata", 150.0, "https://hackup.co.uk/newsimage/1634564515monthly-subcription.png");
        this.subscriptionService.save("Annual Plan", "godishna pretplata", 1500.0, "https://roselightvideo.com/wp-content/uploads/2016/05/1-Year-Subscription.jpg");
        List<Subscription> subscriptions = this.subscriptionService.findAll();

        this.discountService.create(LocalDate.of(2022, 11, 25), "popust", 50.0 );
    }
