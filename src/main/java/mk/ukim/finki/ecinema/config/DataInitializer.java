...
public class DataInitializer {
    ...
    public void initData() {
        ...
        //movies
        this.movieService.create("A dog's way home", "A devoted, homesick dog goes on a treacherous journey across the American heartland to be reunited with her owner", directors.get(0),categories.get(0), LocalDate.now(), LocalDate.of(2022, 11,5),null,"images/dog.jpg");
        this.movieService.create("Against the ice", "Exploring Greenland's vast landscape for a lost map, two men must fight to survive. Based on the true story of Denmark's 1909 polar expedition", directors.get(1),categories.get(2), LocalDate.now(), LocalDate.of(2023, 11, 3),null, "images/against.jpeg");
        this.movieService.create("Love Tactics", "An ad executive and a fashion designer-blogger don't believe in love, so they place a bet to make the other fall head over heels.", directors.get(2),categories.get(3), LocalDate.now(), LocalDate.of(2023, 11, 25),null, "images/love.jpg");
        this.movieService.create("Red Notice", "An FBI profiler pursuing the world's most wanted art thief becomes his reluctant partner in crime to catch an elusive crook who's always one step ahead", directors.get(3),categories.get(5), LocalDate.now(), LocalDate.of(2023, 11, 11),null, "images/red notice.jpg");
        this.movieService.create("The Equalizer 2", "Ex-CIA agent-turned-vigilante Robert McCall uses his deadly skills once again to avenge the death of a close friend and former colleague", directors.get(4),categories.get(4), LocalDate.now(), LocalDate.of(2023, 11, 25),null, "images/the eq.jpg");
        this.movieService.create("Baywatch", "To save their beach, elite lifeguard Mitch Buchannon and a former Olympian probe a criminal plot that threatens the future of the bay.", directors.get(5),categories.get(4), LocalDate.now(), LocalDate.of(2023, 11, 25),null, "images/baywatchh.jpg");
